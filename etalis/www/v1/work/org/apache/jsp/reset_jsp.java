  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (application) {
        etalisIO = (com.etalis.ioEtalis) _jspx_page_context.getAttribute("etalisIO", PageContext.APPLICATION_SCOPE);
        if (etalisIO == null){
          etalisIO = new com.etalis.ioEtalis();
          _jspx_page_context.setAttribute("etalisIO", etalisIO, PageContext.APPLICATION_SCOPE);
        }
      }
      out.write("\r\n");
      out.write("<html>\r\n");
