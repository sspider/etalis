...
public class NumberedEventStream {
	 ...
	 */
	void generateEventStream(double number, double p)  {
	...
	public static void main( String argv[]) {
		NumberedEventStream stream1 = new NumberedEventStream();
		...
		stream1.generateEventStream(20000, 0.6);
	}
}
