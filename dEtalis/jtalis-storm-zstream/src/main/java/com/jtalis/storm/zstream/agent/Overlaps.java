 ...
 * "overlaps" with another event (from right-child-buffer) according to the 
 ...
 *
 */
public class Overlaps extends AbstractSequenceOperator {

	public Overlaps(IChannel outChannel, long timeWindow) {
