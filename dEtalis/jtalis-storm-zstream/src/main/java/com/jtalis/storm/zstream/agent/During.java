 ...
 * occurred "during" another event (from right-child-buffer) according to 
 * the Allen's Interval Algebra.
 ...
 *
 */
public class During extends AbstractSequenceOperator {

	public During(IChannel outChannel, long timeWindow) {
