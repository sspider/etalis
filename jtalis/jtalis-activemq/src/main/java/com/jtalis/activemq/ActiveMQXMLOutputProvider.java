...
public class ActiveMQXMLOutputProvider implements JtalisOutputEventProvider {
	@Parameter("url")
	private String url;
	@Parameter("topic")
	...
	public ActiveMQXMLOutputProvider() {
		
	}
	
	public ActiveMQXMLOutputProvider(String url, String topic) throws ProviderSetupException {
	...
	public void outputEvent(EtalisEvent event) {
		// TODO Auto-generated method stub
		try {
			publisher.send(session.createTextMessage(CreateXMLMessage.buildXMLMessageFromEtalisEvent(event)));
		} catch (JMSException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
